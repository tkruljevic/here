 ...
 */
public class HomeScreenCameraIconClickListener implements View.OnClickListener {
    ...
    HomeScreenCameraIconClickListener(Context context, View sheet) {
        this(context, sheet, null);
    }

    HomeScreenCameraIconClickListener(Context context, View sheet, @Nullable Interpolator interpolator) {
        this(context, sheet, interpolator, null, null);
    }

    HomeScreenCameraIconClickListener(
    ...
    public void onClick(View view) {
        ...
        final int translateY = height -
                context.getResources().getDimensionPixelSize(R.dimen.grid_height);
